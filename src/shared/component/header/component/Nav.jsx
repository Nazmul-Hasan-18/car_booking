...
const Nav = () => {
    ...
    return (
        <div className='bg-black'>
            <div className='container mx-auto md:px-34 px-4 flex justify-between items-center py-3.5'>
                ...
                <div className=' md:hidden'>
                    ...
                    <div className={` ${click ? 'block' : 'hidden'} absolute top-10 z-30 -left-8 overflow-hidden`}>
                       <div className='md:text-[15px] text-[14px] px-8 py-6 border-t border-gray-800 bg-black w-97  flex flex-col  gap-4  uppercase font-semibold text-white '>
                        {
                            items.map(items => (
                                <div>
                                    <Link to={items.path}>
