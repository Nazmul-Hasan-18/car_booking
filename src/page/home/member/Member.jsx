...
const Member = () => {
    ...
    return (
        <div className='container mx-auto px-34 py-15  flex flex-col items-center'>
              <div className='text-center py-5' >
                <p className='font-semibold text-lg mainColor'>experts</p>
                <h2 className='text-[46px] font-semibold '>Our Members</h2>
            </div>
            <div className='grid grid-cols-4 gap-7 py-4'>
             ...
             <div className=''>
                    <p className='uppercase mt-9 font-semibold hover:text-white w-48 text-center py-3 hover:bg-[#ec3323] duration-300 cursor-pointer border-2 border-[#ec3323]'>become a driver</p>
            </div>
        </div>
    );
};
